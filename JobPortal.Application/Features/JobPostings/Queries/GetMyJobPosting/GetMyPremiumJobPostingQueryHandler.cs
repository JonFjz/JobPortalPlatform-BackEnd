...
public class GetMyPremiumJobPostingQueryHandler:IRequestHandler<GetMyPremiumJobPostingQuery,PagedResult<MyPremiumJobPostingDto>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;
    private readonly IClaimsPrincipalAccessor _claimsPrincipalAccessor;

    public GetMyPremiumJobPostingQueryHandler(IUnitOfWork unitOfWork,IMapper mapper,IClaimsPrincipalAccessor claimsPrincipalAccessor)
    {
        _unitOfWork = unitOfWork;
        _mapper = mapper;
        _claimsPrincipalAccessor = claimsPrincipalAccessor;
    }
    public async Task<PagedResult<MyPremiumJobPostingDto>> Handle(GetMyPremiumJobPostingQuery request, CancellationToken cancellationToken)
    {
        ...
        var jobPostingDtos = _mapper.Map<List<MyPremiumJobPostingDto>>(jobPostings);

        return new PagedResult<MyPremiumJobPostingDto>
        {
